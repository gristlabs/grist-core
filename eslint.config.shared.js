...
// projectRoot/lintExt are explicit (rather than read from process.cwd()) so
// this module stays correct when cached across eslint_d invocations from
// different cwds.
function makeConfig({ projectRoot, lintExt }) {
  return defineConfig([
    {
