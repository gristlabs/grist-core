...
# Fetch python3.14
FROM python:3.14-slim-trixie AS collector-py3
...
# Copy python3 files.
COPY --from=collector-py3 /usr/local/bin/python3.14 /usr/bin/python3.14
COPY --from=collector-py3 /usr/local/lib/python3.14 /usr/local/lib/python3.14
COPY --from=collector-py3 /usr/local/lib/libpython3.14.* /usr/local/lib/
