...
| GRIST_AUTHENTICATED_FORMS | When set to `true`, form replies done from an authenticated device are attributed to that user, instead of being forcefully anonymized (default since 1.7.7). |
