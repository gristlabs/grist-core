...
| GRIST_CUSTOM_COMMON_URLS | overwrite the default commons URLs. It's value is expected to be a JSON object and a subset of the [ICommonUrls interface](./app/common/ICommonUrls.ts). |
