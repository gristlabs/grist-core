...
import {GroupUsersCreatedAt1745934227526
  as GroupUsersCreatedAt} from 'app/gen-server/migration/1745934227526-GroupUsersCreatedAt';
...
const migrations = [Initial, Login, PinDocs, UserPicture, DisplayEmail, DisplayEmailNonNull,
                    ...
                    UserCreatedAt, GroupUsersCreatedAt];
