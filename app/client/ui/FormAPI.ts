...
export interface FormFieldOptions {
  ...
  /** Minimum length for the text response. Defaults to `-1` (no constraint). */
  formTextMinimumLength?: number;
  /** Maximum length for the text response. Defaults to `-1` (no constraint). */
