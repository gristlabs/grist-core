...
const tokensCssMapping = {
  ...
  selection: 'selection',
  selectionOpaque: 'selection-opaque',
  selectionDarkerOpaque: 'selection-darker-opaque',
...
export const components = Object.fromEntries(
  Object.entries(componentsCssMapping).map(([name, value]) => [name, new CssCustomProp(value)])
) as Record<keyof typeof componentsCssMapping, CssCustomProp>;
